...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        # TODO: YOUR CODE HERE
        return [
            "You're in the room with the green plant.",
            "You're in the room with the large piano.",
            "You're in the room with the sky light.",
            "You're in the room with the yellow dog.",
        ][room_number]
